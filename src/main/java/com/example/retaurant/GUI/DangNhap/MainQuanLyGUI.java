...
//        pnTitle.setBackground(new Color(242, 153, 74));
        ...
        JLabel lblTitleText = new JLabel(new ImageIcon(""));
        lblTitleText.setBounds(width / 2 - 428 / 2, 3, 428, 38);
        
        pnTitle.add(lblTitleText);
        //cua so Jframe
        setSize(800, 600); // Kích thước cửa sổ
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Đóng cửa sổ khi nhấn nút X
        ...
        JLabel lblAvatar = new JLabel(new ImageIcon(""), JLabel.CENTER);
