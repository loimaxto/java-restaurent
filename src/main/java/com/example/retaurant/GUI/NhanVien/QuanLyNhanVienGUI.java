package com.example.retaurant.GUI.NhanVien;

import com.example.retaurant.MyCustom.ImagePanel;
import com.example.retaurant.MyCustom.MyDialog;
import com.example.retaurant.MyCustom.MyTable;
import com.example.retaurant.MyCustom.TransparentPanel;
import com.example.retaurant.MyCustom.XuLyFileExecl;
import javax.swing.JPanel;
import com.example.retaurant.BUS.NhanVienBUS;
import com.example.retaurant.BUS.PhanQuyenBUS;
import com.example.retaurant.BUS.TaiKhoanBUS;
...
//           changLNF("Windows");
    ...
    private void addControlsNhanVien() {
        ...
        pnTen.add(lblMaTaiKhoan);
        pnTen.add(txtMaTaiKhoan);
        pnText.add(pnTen);
...
//    }
    ...
    private void xuLyNhapExcel() {
        ...
        XuLyFileExecl nhapExcel = new XuLyFileExecl();
...
//            nhanVienBUS.nhapExcel(hoTen, gioiTinh, chucVu, maTaiKhoan);
    ...
    private void xuLyXuatExcel() {
        XuLyFileExecl xuatExcel = new XuLyFileExecl();
    ...
    private void xuLyThemNhanVien() {
        ...
        String chucVu = txtChucVu.getText();
        String maTaiKhoan = txtMaTaiKhoan.getText();
        if (nhanVienBUS.themNhanVien(hoTen, gioiTinh, chucVu, maTaiKhoan)) {
            nhanVienBUS.docDanhSach();
            loadDataTblNhanVien();
        }
    }
