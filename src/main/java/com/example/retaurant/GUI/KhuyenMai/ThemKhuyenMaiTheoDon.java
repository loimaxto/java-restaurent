 ...
 */
public class ThemKhuyenMaiTheoDon extends javax.swing.JFrame {

    /**
     * Creates new form ThemKhuyenMaiTheoDon
     */
    public ThemKhuyenMaiTheoDon() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thêm Khuyến Mãi Đơn Hàng");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemKhuyenMaiTheoDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemKhuyenMaiTheoDon().setVisible(true);
            }
        });
    }
